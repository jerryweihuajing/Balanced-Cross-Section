...
#改变图片尺寸增加padding
img_tag,img_rgb=Init.AddPadding(img_rgb,rgb_dict,m_row=30,n_column=150,show=True,axis=True)
...
#    
#fractions=final_layers+total_faults
#
#Dis.ShowFractions(fractions,img_rgb,rgb_dict,axis=True)
